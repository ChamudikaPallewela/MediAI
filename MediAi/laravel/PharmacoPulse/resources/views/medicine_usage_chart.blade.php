...
<a href="{{ url('/redirects') }}" class="brand" style="display: flex; align-items: center; justify-content: flex-start;">
	...
	<section id="content">
		...
		<nav>
		 ...
		 <div id="charts-container" style="width: 50%; margin: 1%;">
    ...
    'rgba(255, 20, 147, 0.2)'   // DeepPink
            ...
            Object.keys(chartData).forEach((drugName, index) => {
                // Create a container for each pair of charts
                ...
                lineCanvas.id = 'line-chart-' + index;
                lineCanvas.style.flex = '3';
                chartContainer.appendChild(lineCanvas);

                // Create a canvas for the Polar Area Chart
                var polarCanvas = document.createElement('canvas');
                polarCanvas.id = 'polar-chart-' + index;
                polarCanvas.style.flex = '1'; // Adjust the flex value for a smaller chart
                polarCanvas.style.maxWidth = '500px'; // Set a maximum width for the Polar Area Chart
                polarCanvas.style.maxHeight = '500px'; // Set a maximum height for the Polar Area Chart
                chartContainer.appendChild(polarCanvas);

                // Data for the charts
                var data = monthNames.map(month => chartData[drugName][month] || 0);
                ...
                new Chart(lineCanvas.getContext('2d'), {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Medicine Usage for ' + drugName + ' (Line Chart)'
                            }
                        }
                    }
                });
                ...
                new Chart(polarCanvas.getContext('2d'), {
                    ...
                    options: {
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'Medicine Usage for ' + drugName + ' (Polar Area Chart)'
                            }
                        }
                    }
                });
