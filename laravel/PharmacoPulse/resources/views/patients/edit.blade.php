    ...
    <div>
        ...
        <form action="{{ route('patients.update', $patient->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="patient_name" class="form-control" value="{{ $patient->patient_name }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="clinic_id" class="form-control" required>
                    @foreach ($clinics as $clinic)
                        <option value="{{ $clinic->id }}" @if($patient->clinic_id == $clinic->id) selected @endif>{{ $clinic->clinic_name }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="id_number" class="form-control" value="{{ $patient->id_number }}">
            </div>
